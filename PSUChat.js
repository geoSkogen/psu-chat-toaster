...
PSUCHATMODULE.validatePage = false;
// if true, the current page must be in the validPages array or no chat code will be enabled.
PSUCHATMODULE.validPages = [];
PSUCHATMODULE.FAPages = ["chattestFA.html", "chattestFA", "pdx.edu/finaid/"];
PSUCHATMODULE.IELPPages = ["chattestIELP.html", "chattestIELP", "pdx.edu/esl/"];
PSUCHATMODULE.SFSPages = ["chattestSFS.html", "chattestSFS", "pdx.edu/student-financial/"];
PSUCHATMODULE.EAPEERPages = ["chattestEAPEER.html", "chattestEAPEER", "pdx.edu/ed-abroad/", "vikingsabroad.pdx.edu/"];
PSUCHATMODULE.TAPSPages = ["chattestTAPS.html", "chattestTAPS", "pdx.edu/transportation/"];
PSUCHATMODULE.HRPages = ["chattestHR.html", "chattestHR", "pdx.edu/hr/"];
PSUCHATMODULE.REGPages = ["chattestREG.html", "chattestREG", "pdx.edu/registration/"];
PSUCHATMODULE.TransferPages = ["chattesttc.html", "chattesttc", "pdx.edu/advising/transfer-center"];
PSUCHATMODULE.CareerPages = ["chattestcc.html", "chattestcc", "pdx.edu/careers/"];
PSUCHATMODULE.CLASDeanPages = ["chattestclasdean.html", "chattestclasdean", "pdx.edu/clas/"];
PSUCHATMODULE.CLASESMPages = ["chattestesm.html", "chattestesm", "chattestclasesm.html", "chattestclasesm", "pdx.edu/esm/"];
PSUCHATMODULE.CUPAPAPages = ["chattestcupaPA.html", "chattestcupaPA", "pdx.edu/hatfieldschool/department-of-public-administration"];
PSUCHATMODULE.SBGRADPages = ["chattestsbgrad.html", "chattestsbgrad", "pdx.edu/sba/graduate-business-programs", "pdx.edu/sba/academic-programs-0", "pdx.edu/sba/why-graduate-business-at-portland-state", "pdx.edu/sba/graduate-business-programs-admissions"];
PSUCHATMODULE.GDIPages = ["chattestgdi.html", "chattestgdi", "pdx.edu/diversity/", "pdx.edu/student-life/global-diversity-inclusion", "pdx.edu/diversity/equity-compliance", "pdx.edu/diversity/diversity-education-learning", "pdx.edu/diversity/diversity-equity-and-inclusion-advocacy", "pdx.edu/diversity/student-support-programs", "pdx.edu/diversity/contact"];

PSUCHATMODULE.teamSettings = {
    ADM: {
        team: "ADM",
        offerNoChat_text: "Contact Admissions",
        offerChat_text: "Chat with Admissions",
        offhoursText: "<a href=\"mailto:admissions@pdx.edu\">Contact PSU Admissions by email</a> " + "or return to our website during our Live Chat hours from 9:00 am to 4:45 pm PT M-F.",
    ...
    FA: {
        team: "FA",
        offerNoChat_text: "Contact Financial Aid",
        offerChat_text: "Chat with Financial Aid",
    ...
    IELP: {
        team: "IELP",
        offerNoChat_text: "Contact IELP Admissions",
        offerChat_text: "Chat with IELP Admissions",
    ...
    SFS: {
        team: "SFS",
        offerNoChat_text: "Chat with Student Financial Services",
        offerChat_text: "Chat with Student Financial Services",
    ...
    EAPEER: {
        team: "EAPEER",
        offerNoChat_text: "Chat with PSU Education Abroad",
        offerChat_text: "Chat with PSU Education Abroad",
    ...
    TAPS: {
        team: "TAPS",
        offerNoChat_text: "Chat with PSU Parking and Transportation",
        offerChat_text: "Chat with PSU Parking and Transportation",
    ...
    HR: {
        team: "HR",
        offerNoChat_text: "Office of Human Resources",
        offerChat_text: "Chat with Office of Human Resources",
    ...
    REG: {
        team: "REG",
        offerNoChat_text: "Registrar's Office",
        offerChat_text: "Chat with the Registrar's Office!",
    ...
    Transfer: {
        team: "Transfer",
        offerNoChat_text: "Career and Transfer Centers Office",
        offerChat_text: "Chat with the Career & Transfer Centers!",
    ...
    CLASDEAN: {
        team: "CLASDEAN",
        offerNoChat_text: "CLAS Dean Office",
        offerChat_text: "Chat with the CLAS Dean Office!",
    ...
    CLASESM: {
        team: "CLASESM",
        offerNoChat_text: "Environmental Science & Management Office",
        offerChat_text: "Chat with the Environmental Science & Management Office!",
    ...
    Transfer: {
        team: "Transfer",
        offerNoChat_text: "Career and Transfer Centers Front Office",
        offerChat_text: "Chat with the Career and Transfer Centers Office!",
    ...
    CUPAPA: {
        team: "CUPAPA",
        offerNoChat_text: "Public Administration",
        offerChat_text: "Chat with Public Administration!",
    ...
    SBGRAD: {
        team: "SBGRAD",
        offerNoChat_text: "Graduate Business Programs",
        offerChat_text: "Chat with Graduate Business Programs!",
    ...
    GDI: {
        team: "GDI",
        offerNoChat_text: "Global Diversity & Inclusion",
        offerChat_text: "Chat with us! How may we assist you?",
...
PSUCHATMODULE.onValidPage = function() {
    ...
    var teamToLoad = PSUCHATMODULE.teamSettings.ADM;
    //default
...
PSUCHATMODULE.loadTeamSettings = function(theTeam) {
    ...
    if (PSUCHATMODULE.showSBGradField)
        PSUCHATMODULE.formExpand = PSUCHATMODULE.formExpand_AddField;

    if (PSUCHATMODULE.emailText)
        PSUCHATMODULE.formExpand = PSUCHATMODULE.formExpand_AddEmail;

    PSUCHATMODULE.formExpand += PSUCHATMODULE.formExpand_remodel;
}
...
PSUCHATMODULE.loadStyle = function() {
    ...
    ".chat_controls label {font-size:14px;color:#1d252d;display:block;float:none;width:autp;text-align:right;padding:0.33em 0.66em 0 0;margin-bottom:0;font-weight:600;min-width:90px;max-width:95px;}\n" +
    ".chat_controls_inner { padding-top:3px;max-width:160px;min-width:160px; }\n" +
    ".chat_controls_invalid {border:solid 2px red;}\n" +
    ".chat_underbarInput {width:100%;color:#1d252d;font-size:13px;font-weight:600;opacity:0.8;padding:0.15em 0.5em;}\n" +
    ...
    var strLongHeaderStyle = "div.chat_underbar {position: fixed;right:20px;bottom: 0px;height:0px;margin:0px;padding:0px;border:none;width:auto;overflow:hidden;z-index:250;}\n" +
    "div.chat_underbar div.chat_offerChat {width:300px;height:auto;margin:0px;padding:0px;border-width:0px;background-color:#ededee;text-align:center;}\n" +
    "div.chat_underbar div.chat_offerNoChat {width:300px;height:200px;margin:0px;padding:0px;background-color:#e86d1f;text-align:center;}\n" +
    "div.chat_header {height:auto;color:#ededee;background-color:black;border:0px;padding:6px 14px;margin:0px;text-align:left;}\n" +
    "div.chat_close {float:right;height:28px;width:21px;padding:0px 0px 0px 0px;color:white;text-align:right;vertical-align:top;}\n" +
...
PSUCHATMODULE.createChatElement = function() {
    ...
    offerBarHeader.innerHTML = "<div class=\"chat_close\"><a href=\"javascript:PSUCHATMODULE.showChatUnderbar()\"><span id=\"chat_icon_open\" aria-hidden=\"true\"><img src=\"https://crm.pdx.edu/Media/static/images/chevron-up.png\" alt=\"Open\" style=\"height:17px;width:19px;border:0px;margin:0px;padding:0px;\" /></span>" + "<span id=\"chat_icon_close\" aria-hidden=\"true\" style=\"display:none\"><img src=\"https://crm.pdx.edu/Media/static/images/close.png\" alt=\"Close\" style=\"height:13px;width:14px;border:0px;margin:0px;padding:0px;\" /></span></a></div>\n" + "<a class=\"chat_headerText\" href=\"javascript:PSUCHATMODULE.showChatUnderbar()\">" + headerTextToUse + "</a>";
	...
	*/
    ...
    PSUCHATMODULE.headerExpand = PSUCHATMODULE.getRenderedHeaderHeight()
